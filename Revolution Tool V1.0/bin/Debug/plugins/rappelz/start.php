...
*
* @package adm
* @version $Id: start.php 2119 2012-12-22 14:31:15Z saanina $
...
{
	$hurry_groups_list .= '<option value="' . $id . '">' . preg_replace_callback('!{lang.([A-Z0-9]+)}!e', '$lang[\'\\1\']', $d_groups[$id]['data']['group_name']) . '</option>';
}
